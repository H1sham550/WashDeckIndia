      ...
      <div className="grid w-full grid-cols-1 md:grid-cols-[1.1fr_1fr] lg:grid-cols-[1.3fr_1fr]">
        ...
        <section className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#07162c] via-[#0b2240] to-[#0f3564] p-12 text-white md:flex">
          ...
          <div className="relative z-10 my-auto max-w-lg space-y-8">
            ...
            {/* Interactive Mock Live Queue Card */}
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md shadow-2xl shadow-black/20">
              <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-300">Live Detailing Queue</span>
                </div>
              ...
              <div className="space-y-3">
                {/* Queue Item 1 */}
                <div className="flex items-center justify-between rounded-xl bg-white/5 px-4 py-3 border border-white/5 hover:border-white/10 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-emerald-500/20 flex items-center justify-center text-emerald-300 font-bold text-xs">
                      SUV
                    </div>
                    <div>
                      <h4 className="text-xs font-bold">KA03HA1234</h4>
                      <p className="text-[10px] text-slate-400">Hyundai Creta • Foam Wash</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-xl bg-white/5 px-4 py-3 border border-white/5 hover:border-white/10 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-amber-500/20 flex items-center justify-center text-amber-300 font-bold text-xs">
                      SED
                    </div>
                    <div>
                      <h4 className="text-xs font-bold">DL01A5678</h4>
                      <p className="text-[10px] text-slate-400">Honda City • Interior Detailing</p>
                    </div>
                  </div>
