...
import { TrendingUp, BarChart2, ShieldAlert, Award, CreditCard, Sparkles, Car } from "lucide-react";
    ...
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center space-y-4 font-sans">
        ...
        <p className="text-sm text-slate-500 max-w-sm mx-auto leading-relaxed">
          Analytics & Business Intelligence are not enabled under your current subscription plan. Upgrade your plan in settings to unlock metrics tracking.
        </p>
      </div>
    );
  }
