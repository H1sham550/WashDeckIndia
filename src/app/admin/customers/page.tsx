    ...
    stationsRaw = [
      {
        ...
        status: "ACTIVE",
        createdAt: new Date(),
        branding: { squareLogoUrl: null, businessPhone: "+91 98765 43210", businessEmail: "info@washdeck.in" },
        users: [{ id: "mock-user-1", name: "Rahul Sharma", email: "rahul@washdeck.in" }],
      ...
      },
      {
        ...
        status: "ACTIVE",
        createdAt: new Date(),
        branding: { squareLogoUrl: null, businessPhone: "+91 87654 32109", businessEmail: "contact@washdeck.in" },
        users: [{ id: "mock-user-2", name: "Priya Menon", email: "priya@washdeck.in" }],
