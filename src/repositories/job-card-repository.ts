    ...
    return [
      {
        ...
        status: "RECEIVED",
        createdAt: new Date(),
        vehicle: { id: "v1", vehicleNumber: "KSA 4492", vehicleType: "SUV", brand: "Toyota", model: "Land Cruiser" },
      ...
      },
      {
        ...
        status: "IN_PROGRESS",
        createdAt: new Date(),
        vehicle: { id: "v2", vehicleNumber: "KSA 8810", vehicleType: "SEDAN", brand: "Porsche", model: "Taycan" },
